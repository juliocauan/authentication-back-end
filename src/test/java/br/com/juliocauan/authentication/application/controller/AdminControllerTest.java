...
class AdminControllerTest extends TestContext {
        ...
        void updateUserRoles_error_adminException() throws Exception {
                ...
                getMockMvc().perform(
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("You can not update/delete your own account here!"));
        }
        ...
        void disableUser() throws Exception {
                ...
                getMockMvc().perform(
                                ...
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.message")
                                                .value("User [%s] disabled successfully!".formatted(username)));
        }
        ...
        void disableUser_error_adminException() throws Exception {
                getMockMvc().perform(
                                delete(urlAdminUsers)
                                                .header(authorizationHeader, getAdminToken())
                                                .queryParam("username", usernameAdmin))
                                .andExpect(status().isBadRequest())
                                .andExpect(jsonPath("$.message")
                                                .value("You can not update/delete your own account here!"));
        }
        ...
        void registerRole() throws Exception {
                ...
                getMockMvc().perform(
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("Role [%s] registered successfully!".formatted(role)));
        }
        ...
        void deleteRole() throws Exception {
                ...
                getMockMvc().perform(
                                ...
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.message")
                                                .value("Role [%s] deleted successfully!".formatted(role)));
        }
        ...
        void setEmailer() throws Exception {
                EmailAccess emailAccess = new EmailAccess().username(getRandomUsername()).key(getRandomPassword())
                                .emailType(EmailType.GREEN_MAIL);
                getMockMvc().perform(
                                put(urlAdminEmail)
                                                .header(authorizationHeader, getAdminToken())
                                                .contentType(MediaType.APPLICATION_JSON)
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("[%s] set successfully!"
                                                                .formatted(EmailType.GREEN_MAIL.getValue())));
        }
